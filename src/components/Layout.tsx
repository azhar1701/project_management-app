    ...
    <div className="flex h-screen bg-paper text-ink font-sans overflow-hidden">
      ...
      <aside aria-label="Main navigation" className={cn(
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-ink shrink-0">
          ...
          <button onClick={() => setIsSidebarOpen(!isSidebarOpen)} aria-label={isSidebarOpen ? 'Collapse sidebar' : 'Expand sidebar'} className={cn("p-1 hover:bg-paper rounded-none border border-transparent hover:border-ink text-ink shrink-0 transition-colors", !isSidebarOpen && "mx-auto")}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-16 bg-surface border-b border-ink flex items-center justify-between px-6 shrink-0">
          <div className="flex-1 max-w-xl">
            <div className="relative">
              ...
              <input
                ...
                aria-label="Search projects, tasks, or locations"
          ...
          <div className="flex items-center gap-4 ml-4 shrink-0">
            <button aria-label="Notifications" className="relative p-2 text-ink hover:bg-paper border border-transparent hover:border-ink rounded-none transition-colors">
        ...
        {/* Page Content */}
        <main role="main" className="flex-1 overflow-auto p-4 md:p-8 bg-paper">
          <Outlet />
        </main>
      </div>
    </div>
